...
class QListBoxItem : public QObject, public BStringItem
{
    Q_OBJECT
public:
    QListBoxItem():BStringItem("") { /*m_bSelectable = true;*/ }

    void setSelectable( bool bSelectable ) { SetEnabled( bSelectable ); }
