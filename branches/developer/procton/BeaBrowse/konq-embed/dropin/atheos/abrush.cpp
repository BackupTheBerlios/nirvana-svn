...
{
	kdDebug(10) << "QBrush::" << __FUNCTION__ << "()" << endl;
  data = new QBrushData;
  CHECK_PTR( data );
  data->style	 = style;
  data->color	 = color;
...
QBrush::QBrush()
{
	kdDebug(10) << "QBrush::" << __FUNCTION__ << "1()" << endl;
...
{
	kdDebug(10) << "QBrush::" << __FUNCTION__ << "2()" << endl;
  init( Qt::black, style );
}
...
{
	kdDebug(10) << "QBrush::" << __FUNCTION__ << "3()" << endl;
  init( color, style );
}
...
{
	kdDebug(10) << "QBrush::" << __FUNCTION__ << "4()" << endl;
...
{
	kdDebug(10) << "QBrush::" << __FUNCTION__ << "5()" << endl;
  data = b.data;
  data->ref();
}
